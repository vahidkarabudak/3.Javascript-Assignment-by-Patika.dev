...
let foodCategory = menu.reduce((values,item) => {
...
let categoryListBtns = () => {
  let btns = foodCategory.map((category) => {
    return `<button class="btn btn-outline-dark btn-item">${category}</button>` 
  }).join("")
  btnContainer.innerHTML = btns
  let filterBtns = document.querySelectorAll(".btn-item") // "btn-item" class'ındaki bütün elementleri seçer
